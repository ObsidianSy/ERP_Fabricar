...
export const QuickFilters: React.FC<QuickFiltersProps> = ({
  ...
  // Local input state to avoid UI lag while filters are debounced
  const [localSearch, setLocalSearch] = useState<string>(filters.searchTerm || '');

  // Keep local input in sync when filters change externally (e.g., limpar filtros)
  useEffect(() => {
        ...
        <div className="relative flex-1 min-w-[200px] max-w-md">
          ...
          <Input
            ...
            onChange={(e) => {
              ...
              setLocalSearch(v);
              // updateFilter já faz debounce internamente para "searchTerm"
