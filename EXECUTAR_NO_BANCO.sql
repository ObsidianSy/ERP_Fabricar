-- =====================================================
-- INSTRUÇÕES: Execute este SQL no pgAdmin, DBeaver ou psql
-- =====================================================
...
UNION ALL
SELECT 
  'usuarios_permissoes' AS tabela,
  COUNT(*) AS total
FROM obsidian.usuarios_permissoes;

-- Deve retornar:
-- permissoes: 20
-- usuarios_permissoes: 0 (ainda vazio, será preenchido pela interface)
